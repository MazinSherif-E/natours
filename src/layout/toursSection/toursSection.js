        ...
        <div>
            <section className="section-tours" id="section-tours">
                ...
                <div className="center_text margin_bottom_big">
                    <h2 className="heading_secondary" style={{paddingBottom:"9rem"}}>
                            Most Popular TOurs
                    </h2> 
                        ...
                        <div className="card">
                            ...
                            <div className="card__side card__side--back card__side--back-1">
                                <div className="card__cta">
                                    ...
                                    <a href="#popup" className="btn btnWhite">Book now!</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="center_text margin_top" >
                <a href="#" className="btn btnGreen" >Discover all tours</a>
            </div>
            </section>
        </div>
    )   
